      ...
      <div className="w-1/2 p-6 flex flex-col justify-center">
        <div className="max-w-md mx-auto w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            {/* Name and Last Name Initial - Row */}
            ...
            {/* Nickname and Toggle - Row */}
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-white text-xs font-medium mb-1">
                  Дуудах нэр (заавал биш)
                </label>
                <input
                  type="text"
                  name="nickname"
                  ...
                  onChange={handleChange}
                  className="w-full px-3 py-2 bg-black/20 border border-white/30 rounded-xl focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent transition-all text-white placeholder-white/60 text-xs"
                  placeholder="e.g., Twissu"
                />
              </div>
              <div>
                <label className="block text-white text-xs font-medium mb-1 opacity-0">
                  Toggle
                </label>
                <button
                  type="button"
                  ...
                  className={`w-full px-3 py-2 rounded-xl font-medium transition-all border text-xs ${
