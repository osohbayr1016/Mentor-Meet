        ...
        <div className="w-320 h-[715px] flex rounded-3xl backdrop-blur-[20px] bg-[#33333366] text-white overflow-hidden shadow-xl ">
          ...
          <div className="w-[300px] p-6 flex flex-col  gap-15  bg-[#333333B2]">
            <Link href={"/mentor-calendar"}>
                     <div className="flex flex-row items-center gap-3 text-[20px] font-semibold"><p><ArrowLeft/></p> <p>Буцах</p> </div>
                     </Link>
 ...
 <div className="text-[16px] font-medium flex flex-col gap-3">
    ...
    <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogTrigger asChild>
          <Button variant="outline" className="bg-white text-black px-8 py-2 rounded-full hover:bg-gray-200 transition font-semibold w-[200px] h-[40px"  onClick={() => {
            setShowQr(false); 
             setAgreed(false); 
            setOpen(true); 
          }}> Цаг захиалах</Button>
    ...
    {!showQr ? (
    <form onSubmit={handlePayment} className="flex flex-col justify-center items-center gap-3">
             <DialogHeader>
        ...
        <div className="grid gap-4 text-[14px] text-[#00000099] font-medium px-6 ">
          <p>1. Та уулзалтаа цагаас нь 4 цагийн өмнө цуцлах боломжтой.</p>
          <p>
            2. Өөр суралцагч тухайн менторын цагийг захиалсан тохиолдолд таны
            мөнгө буцаан олгогдоно.
          </p>
      ...
      <div className=" flex flex-col justify-center items-center gap-40">
        <div>
        <p className="text-black font-medium">Төлбөр төлөх QR:</p>
        <Image
        src="/qr.png"
        alt="background"
        width={135}
